...
df_expanded['salary_avg'] = df['salary_avg'].astype('float')

df_expanded['year'] = df_expanded['year'].astype('int')
#df_expanded['salary_avg'] = df_expanded['salary_avg'].astype('int')
df_expanded = df_expanded.interpolate()
print(df_expanded)
df_final = df_expanded[['year', 'inflation', 'salary_avg', 'inflation_growth', 'salary_depend', 'year_exp', 'salary_growth']]
print(df_final)



df_final.to_csv('data/csv_expanded2.csv')